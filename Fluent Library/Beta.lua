...
local Themes = {
	...
	["Halloween"] = {
	    ...
	    AcrylicMain = Color3.fromRGB(30, 15, 40),
	    AcrylicBorder = Color3.fromRGB(50, 35, 60),
	    AcrylicGradient = ColorSequence.new(Color3.fromRGB(25, 10, 35), Color3.fromRGB(45, 30, 55)),
	    AcrylicNoise = 0.88,
	    TitleBarLine = Color3.fromRGB(60, 40, 70),
	    Tab = Color3.fromRGB(90, 70, 110),
	    Element = Color3.fromRGB(80, 60, 100),
	    ElementBorder = Color3.fromRGB(20, 5, 30),
	    InElementBorder = Color3.fromRGB(70, 50, 90),
	    ElementTransparency = 0.87,
	    ToggleSlider = Color3.fromRGB(80, 60, 100),
	    ToggleToggled = Color3.fromRGB(45, 30, 55),
	    SliderRail = Color3.fromRGB(80, 60, 100),
	    DropdownFrame = Color3.fromRGB(110, 90, 130),
	    DropdownHolder = Color3.fromRGB(25, 10, 35),
	    DropdownBorder = Color3.fromRGB(20, 5, 30),
	    DropdownOption = Color3.fromRGB(80, 60, 100),
	    Keybind = Color3.fromRGB(80, 60, 100),
	    Input = Color3.fromRGB(110, 90, 130),
	    InputFocused = Color3.fromRGB(10, 0, 20),
	    InputIndicator = Color3.fromRGB(100, 80, 120),
	    Dialog = Color3.fromRGB(25, 10, 35),
	    DialogHolder = Color3.fromRGB(20, 5, 30),
	    DialogHolderLine = Color3.fromRGB(15, 0, 25),
	    DialogButton = Color3.fromRGB(25, 10, 35),
	    DialogButtonBorder = Color3.fromRGB(50, 35, 60),
	    DialogBorder = Color3.fromRGB(70, 50, 90),
	    DialogInput = Color3.fromRGB(35, 20, 45),
	    DialogInputLine = Color3.fromRGB(110, 90, 130),
	    Text = Color3.fromRGB(255, 255, 255),
	    SubText = Color3.fromRGB(220, 180, 200),
	    Hover = Color3.fromRGB(85, 65, 105),
	    HoverChange = 0.07,
	},
	["Christmas"] = {
	    Name = "Christmas",
	    Accent = Color3.fromRGB(0, 150, 0),
	    AcrylicMain = Color3.fromRGB(20, 30, 25),
	    AcrylicBorder = Color3.fromRGB(40, 50, 45),
	    AcrylicGradient = ColorSequence.new(Color3.fromRGB(15, 25, 20), Color3.fromRGB(35, 45, 40)),
	    AcrylicNoise = 0.88,
	    TitleBarLine = Color3.fromRGB(50, 60, 55),
	    Tab = Color3.fromRGB(80, 100, 85),
	    Element = Color3.fromRGB(70, 90, 75),
	    ElementBorder = Color3.fromRGB(10, 20, 15),
	    InElementBorder = Color3.fromRGB(60, 80, 65),
	    ElementTransparency = 0.87,
	    ToggleSlider = Color3.fromRGB(70, 90, 75),
	    ToggleToggled = Color3.fromRGB(35, 45, 40),
	    SliderRail = Color3.fromRGB(70, 90, 75),
	    DropdownFrame = Color3.fromRGB(100, 120, 105),
	    DropdownHolder = Color3.fromRGB(15, 25, 20),
	    DropdownBorder = Color3.fromRGB(10, 20, 15),
	    DropdownOption = Color3.fromRGB(70, 90, 75),
	    Keybind = Color3.fromRGB(70, 90, 75),
	    Input = Color3.fromRGB(100, 120, 105),
	    InputFocused = Color3.fromRGB(5, 15, 10),
	    InputIndicator = Color3.fromRGB(90, 110, 95),
	    Dialog = Color3.fromRGB(15, 25, 20),
	    DialogHolder = Color3.fromRGB(10, 20, 15),
	    DialogHolderLine = Color3.fromRGB(5, 15, 10),
	    DialogButton = Color3.fromRGB(15, 25, 20),
	    DialogButtonBorder = Color3.fromRGB(40, 50, 45),
	    DialogBorder = Color3.fromRGB(60, 70, 65),
	    DialogInput = Color3.fromRGB(25, 35, 30),
	    DialogInputLine = Color3.fromRGB(100, 120, 105),
	    Text = Color3.fromRGB(255, 255, 255),
	    SubText = Color3.fromRGB(200, 220, 200),
	    Hover = Color3.fromRGB(75, 95, 80),
	    HoverChange = 0.07,
	},
	["Shadow Pulse"] = {
		Name = "Shadow Pulse",
	...
	return function(Config)
		...
		function Window:Dialog(Config)
			...
			for _, Button in next, Config.Buttons do
				Dialog:Button(Translate(Button.Title), Button.Callback)
			end
		...
		function Window:AddTab(TabConfig)
			return TabModule:New(Translate(TabConfig.Title), TabConfig.Icon, Window.TabHolder)
		end
