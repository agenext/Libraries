...
local function ButtonFrame(Instance, Title, Description, HolderSize)
	...
	Label:SetTitle(Transtale(Title))
	Label:SetDesc(Transtale(Description))
	return Frame, Label
end
...
function redzlib:MakeWindow(Configs)
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddParagraph(Configs)
			local PName = Transtale(Configs[1]) or Transtale(Configs.Title) or Transtale("Paragraph")
			local PDesc = Transtale(Configs[2]) or Transtale(Configs.Text) or ""
		...
		function Tab:AddButton(Configs)
			local BName = Transtale(Configs[1]) or Transtale(Configs.Name) or Transtale(Configs.Title) or Transtale("Button!")
			local BDescription = Transtale(Configs.Desc) or Transtale(Configs.Description) or ""
		...
		function Tab:AddToggle(Configs)
			local TName = Transtale(Configs[1]) or Transtale(Configs.Name) or Transtale(Configs.Title) or Transtale("Toggle")
			local TDesc = Transtale(Configs.Desc) or Transtale(Configs.Description) or ""
		...
		function Tab:AddDropdown(Configs)
			local DName = Transtale(Configs[1]) or Transtale(Configs.Name) or Transtale(Configs.Title) or "Dropdown"
			local DDesc = Transtale(Configs.Desc) or Transtale(Configs.Description) or ""
		...
		function Tab:AddSlider(Configs)
			local SName = Transtale(Configs[1]) or Transtale(Configs.Name) or Transtale(Configs.Title) or "Slider!"
			local SDesc = Transtale(Configs.Desc) or Transtale(Configs.Description) or ""
		...
		function Tab:AddTextBox(Configs)
			local TName = Transtale(Configs[1]) or Transtale(Configs.Name) or Transtale(Configs.Title) or "Text Box"
			local TDesc = Transtale(Configs.Desc) or Transtale(Configs.Description) or ""
			local TDefault = Configs[2] or Configs.Default or ""
			local TPlaceholderText = Transtale(Configs[5]) or Transtale(Configs.PlaceholderText) or Transtale("Input")
		...
		function Tab:AddDiscordInvite(Configs)
			local Title = Transtale(Configs[1]) or Transtale(Configs.Name) or Transtale(Configs.Title) or Transtale("Discord")
			local Desc = Transtale(Configs.Desc) or Transtale(Configs.Description) or ""
