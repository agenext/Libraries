...
local function ButtonFrame(Instance, Title, Description, HolderSize)
	...
	Label:SetTitle(Translate(Title))
	Label:SetDesc(Translate(Description))
	return Frame, Label
end
...
function redzlib:MakeWindow(Configs)
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddParagraph(Configs)
			local PName = Translate(Configs[1]) or Translate(Configs.Title) or Translate("Paragraph")
			local PDesc = Translate(Configs[2]) or Translate(Configs.Text) or ""
		...
		function Tab:AddButton(Configs)
			local BName = Translate(Configs[1]) or Translate(Configs.Name) or Translate(Configs.Title) or Translate("Button!")
			local BDescription = Translate(Configs.Desc) or Translate(Configs.Description) or ""
		...
		function Tab:AddToggle(Configs)
			local TName = Translate(Configs[1]) or Translate(Configs.Name) or Translate(Configs.Title) or Translate("Toggle")
			local TDesc = Translate(Configs.Desc) or Translate(Configs.Description) or ""
		...
		function Tab:AddDropdown(Configs)
			local DName = Translate(Configs[1]) or Translate(Configs.Name) or Translate(Configs.Title) or "Dropdown"
			local DDesc = Translate(Configs.Desc) or Translate(Configs.Description) or ""
		...
		function Tab:AddSlider(Configs)
			local SName = Translate(Configs[1]) or Translate(Configs.Name) or Translate(Configs.Title) or "Slider!"
			local SDesc = Translate(Configs.Desc) or Translate(Configs.Description) or ""
		...
		function Tab:AddTextBox(Configs)
			local TName = Translate(Configs[1]) or Translate(Configs.Name) or Translate(Configs.Title) or "Text Box"
			local TDesc = Translate(Configs.Desc) or Translate(Configs.Description) or ""
			local TDefault = Configs[2] or Configs.Default or ""
			local TPlaceholderText = Translate(Configs[5]) or Translate(Configs.PlaceholderText) or Translate("Input")
		...
		function Tab:AddDiscordInvite(Configs)
			local Title = Translate(Configs[1]) or Translate(Configs.Name) or Translate(Configs.Title) or Translate("Discord")
			local Desc = Translate(Configs.Desc) or Translate(Configs.Description) or ""
