...
local Translations = {
    ["Name"] = {["BR"] = "Nome", ["US"] = "Name"},
	["Someone"] = {["BR"] = "Alguém", ["US"] = "Someone"},
	["Race"] = {["BR"] = "Raça", ["US"] = "Race"},
	["Farm"] = {["BR"] = "Farmar", ["US"] = "Farm"},
	["Quests"] = {["BR"] = "Missões", ["US"] = "Missões"},
	["And"] = {["BR"] = "E", ["US"] = "And"},
	["Items"] = {["BR"] = "Itens", ["US"] = "Items"},
	["Sea Events"] = {["BR"] = "Eventos Marítimos", ["US"] = "Sea Events"},
	["Sea"] = {["BR"] = "Mar", ["US"] = "Sea"},
	["Seas"] = {["BR"] = "Mares", ["US"] = "Seas"},
	["Event"] = {["BR"] = "Evento", ["US"] = "Event"},
	["Events"] = {["BR"] = "Eventos", ["US"] = "Events"},
	["Island"] = {["BR"] = "Ilha", ["US"] = "Island"},
	["Islands"] = {["BR"] = "Ilhas", ["US"] = "Islands"},
	["Fruit"] = {["BR"] = "Fruta", ["US"] = "Fruit"},
	["Fruits"] = {["BR"] = "Frutas", ["US"] = "Fruits"},
	["Demon Fruit"] = {["BR"] = "Fruta Do Demônio", ["US"] = "Demon Fruit"},
	["Teleport"] = {["BR"] = "Teletransporte", ["US"] = "Teleport"},
	["World"] = {["BR"] = "Mundo", ["US"] = "World"},
	["Worlds"] = {["BR"] = "Mundos", ["US"] = "Worlds"},
	["Player"] = {["BR"] = "Jogador", ["US"] = "Player"},
	["Local"] = {["BR"] = "Local", ["US"] = "Local"},
	["Place"] = {["BR"] = "Local", ["US"] = "Place"},
	["A"] = {["BR"] = "Um", ["US"] = "A"},
	["The"] = {["BR"] = "O", ["US"] = "The"},
	["Stats"] = {["BR"] = "Estatísticas", ["US"] = "Stats"},
	["Shop"] = {["BR"] = "Loja", ["US"] = "Shop"},
	["Store"] = {["BR"] = "Armazenar", ["US"] = "Store"},
	["All"] = {["BR"] = "Todos", ["US"] = "Todos"},
	["Settings"] = {["BR"] = "Configurações", ["US"] = "Settings"},
	["Main"] = {["BR"] = "Principal", ["US"] = "Main"},
	["More"] = {["BR"] = "Mais", ["US"] = "More"},
	["Redeem"] = {["BR"] = "Resgatar", ["US"] = "Redeem"},
	["Codes"] = {["BR"] = "Códigos", ["US"] = "Codes"},
	["Skill"] = {["BR"] = "Habilitade", ["US"] = "Skill"},
	["Enable"] = {["BR"] = "Habilitar", ["US"] = "Enable"},
	["Attack"] = {["BR"] = "Ataque", ["US"] = "Attack"},
	["Bring"] = {["BR"] = "Trazer", ["US"] = "Bring"},
	["Enemies"] = {["BR"] = "Inimigos", ["US"] = "Enemies"},
...
function Translate(phrase)
    ...
    for word in phrase:gmatch("%S+") do
        local key = word
        local translated = Translations[key] and Translations[key][lang] or key
        translated = translated:sub(1,1):upper() .. translated:sub(2)
...
local function ButtonFrame(Instance, Title, Description, HolderSize)
	...
	function Label:SetTitle(NewTitle)
		if type(NewTitle) == "string" and NewTitle:gsub(" ", ""):len() > 0 then
			TitleL.Text = Translate(NewTitle)
		end
	end
	function Label:SetDesc(NewDesc)
		if type(NewDesc) == "string" and NewDesc:gsub(" ", ""):len() > 0 then
			DescL.Visible = true
			DescL.Text = Translate(NewDesc)
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddSection(Configs)
			...
			function Section:Set(New)
				if New then
					SectionLabel.Text = GetStr(Translate(New))
				end
			end
			return Section
		end
		function Tab:AddParagraph(Configs)
			...
			local Frame, LabelFunc = ButtonFrame(Container, Translate(PName), Translate(PDesc), UDim2.new(1, -20))
		...
		function Tab:AddSlider(Configs)
			...
			local Button, LabelFunc = ButtonFrame(Container, Translate(SName), Translate(SDesc), UDim2.new(1, -180))
